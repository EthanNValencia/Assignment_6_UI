...
public class Controller implements CONSTANTS, Initializable {
     ...
     * @param event This event is initiated by the clean button.
     * @throws FileNotFoundException A file not found exception is a critical application failure. The application cannot continue.
     */
    public void cleanText(ActionEvent event) throws FileNotFoundException {
     ...
     * @param event This event is initiated by the count button.
     * @throws FileNotFoundException A file not found exception is a critical application failure. The application cannot continue.
     */
    public void countWords(ActionEvent event) throws FileNotFoundException {
